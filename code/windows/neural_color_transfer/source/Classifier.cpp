...
void Classifier::Predict(const cv::Mat& img, std::vector<std::string>& layers, std::vector<float *>& data_s) {

	// HMM: TEST@grayscale image
	//cv::Mat grayImg = cv::Mat::zeros(img.size(), CV_8UC1);
